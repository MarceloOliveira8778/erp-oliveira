...
@endif
    ...
    $ativo = isset($contato->ativo) ? $contato->ativo : old('ativo');
    $uf = isset($contato->uf) ? $contato->uf : old('uf');
    $cidade = isset($contato->cidade) ? $contato->cidade : old('cidade');
		...
		<div class="p-2">
				...
				<div class="rows">										
					<div class="col-12 mb-4">
						...
						<div><input type="checkbox" name="eh_cliente" class="form-control tipo" id="eh_cliente" value="S" {{(isset($contato->eh_cliente) && ($contato->eh_cliente=='S')) ? 'checked' : ''}}> <label class="p-2 mr-1" for="eh_cliente"><i class="fas fa-user"></i> Contato</label>
						 </div>
						 <div><input type="checkbox" name="eh_fornecedor" class="form-control tipo" id="eh_fornecedor" value="S" {{(isset($contato->eh_fornecedor) && ($contato->eh_fornecedor=='S')) ? 'checked' : ''}}> <label class="p-2 mr-1" for="eh_fornecedor"><i class="fas fa-cart-arrow-down"></i> Fornecedor</label>
						 </div>

						 <div><input type="checkbox" name="eh_transportador" class="form-control tipo" id="eh_transportador" value="S" {{(isset($contato->eh_transportador) && ($contato->eh_transportador=='S')) ? 'checked' : ''}}> <label class="p-2" for="eh_transportador"><i class="fas fa-truck"></i> Transportador</label>
						 </div>
						 </div>
					</div>
				...
				<div class="col-4 mb-3">
						...
						<input type="password" name="senha" value="{{isset($contato->senha) ? $contato->senha : old('senha')}}" placeholder="Digite aqui..." class="form-campo">
				</div>
	  ...
	  <div id="tab-2">
        ...
        <div class="rows">	
            ...
            <div class="col-4 mb-2">
                    ...
                    <select class="form-campo" name="cidade" id="cidade">
        ...
        <div class="p-2">									
            ...
            <div class="rows">
                ...
                <div class="col-4 mb-3">
                         ...
                         <input type="text" name="rg" value="{{isset($contato->rg) ? $contato->rg : old('rg')}}" placeholder="Digite aqui..." class="form-campo">
                 </div>
