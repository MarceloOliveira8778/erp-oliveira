...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de Tipos de Movimento </span>
						<div>
							<a href="{{route('tipomovimento.create')}}" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                        ...
                        @foreach($lista as $tipo)
                             <tr>
                                ...
                                <td align="left">{{$tipo->tipo_movimento}}</td>
								<td align="center">{{$tipo->ent_sai}}</td>
