...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						...
						<div>
							<a href="{{route('unidade.create')}}" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            <thead>
                                    <tr>
                                       ...
                                       <th align="center" width="60%">Nome</th>
                        ...
                        @if(isset($unidades))
                            @foreach($unidades as $unidade)
                             <tr>
                                ...
                                <td align="left">{{$unidade->unidade}}</td>
																			
                                <td align="center"><a href="{{route('unidade.edit', $unidade->id)}}" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>                              </td>									
                                <td align="center"><a href="javascript:if(confirm('Deseja realmente excluir?')) {
                                    window.location.href = '{{route('unidade.excluir', $unidade->id)}}';
                                }" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a>                                </td>
                             </tr>                                       
                             @endforeach
                        @endif
