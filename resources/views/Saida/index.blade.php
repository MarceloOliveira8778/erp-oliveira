...
<div class="col-9 central mb-3">
    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
        <span class="d-flex center-middle"><i class="fas fa-arrow-right mr-1"></i> FILTRAR SAÍDA AVULSA </span>
        <div>
                        ...
                        <div class="border p-3 radius-4 pb-4">
                            <div class="rows">
                                ...
                                <div class="col-3">
                                    ...
                                    <select name="localizacao_id" id="localizacao_id" class="form-campo">
                                    </select>
                                </div>

                                <div class="col-2 mt-1 pt-1">
                                    <input type="hidden" name="produto_id" id="produto_id">
                                    <input type="button" value="Inserir" id="btnInserirProduto" name="btnInserirProduto" class="btn btn-verde width-100">
                                </div>
                            </div>
                        </div>
                                ...
                                <table cellpadding="0" cellspacing="0" class="mb-0 table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th align="left" width="190">Localização</th>
