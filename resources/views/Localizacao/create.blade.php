        ...
        <div class="col-12">
            <div class="caixa">
                <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
                    <span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de Localização </span>
                </div>

                <form name="busca" action="{{route('localizacao.store')}}" method="POST">
                    @csrf
                    <div class="px-2 pt-2">
                        <div class=" bg-padrao mt-2 p-2 radius-4">
                            <div class="rows">
                                <div class="col-6">
                                    ...
                                    <input type="text" required name="localizacao" value="" class="form-campo">
                                </div>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="left"><?php echo $l->localizacao ?></td>
