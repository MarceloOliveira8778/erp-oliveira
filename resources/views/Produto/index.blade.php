            ...
            <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                    ...
                    <tbody>	
						...
						<tr>
							...
							<td align="center">
								@if($produto->ativo=="S")
								<span class="text-verde"><i class="fas fa-check"></i> Sim</span>
								@else
								<span class="text-vermelho"><i class="fa fa-times"></i> Não</span>
								@endif
							</td>
							<td align="center"><a href="{{route('produto.edit', $produto->id)}}" class="btn btn-outline-roxo">Editar</a></td>
